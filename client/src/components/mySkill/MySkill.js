            ...
            <div className={sContainer.containerSectionFrontBack}>
                <div className={sContainer.containerMainProgress}>
                    ...
                    <div className={sContainer.imgIcons}>
                        <img src={react} loading="lazy" style={{width: 80}} alt="ReactJS React-Native"/>
                        <img src={redux} loading="lazy" style={{width: 80}} alt="Redux"/>
                        <img src={css} loading="lazy" style={{width: 80}} alt="CSS"/>
                        <img src={html} loading="lazy" style={{width: 80}} alt="HTML"/>
                        <img src={javascript} style={{width: 55, padding: '0px 12.5px'}} loading="lazy" alt="JavaScript"/>
                    </div>
                </div>
                <div className={sContainer.containerMainProgress}>
                    <h2 className={sText.textMySkillFrontBack}>Back End</h2>
                    <div className={sContainer.imgIconsBack}>
                        <img src={node} loading="lazy" alt="NodeJs"/>
